...
public class Config {
    ...
    public static class Physics {
        ...
        public static double ATTACK_VELOCITY_GROUNDED_DAMPING_HORIZONTAL = 0.3;
        ...
        public static double ATTACK_VELOCITY_KNOCKBACK_NORMAL_MULTIPLIER = 0.7;
    ...
    public static class Combat {
        ...
        public static double ATTACKS_DOWN_AIR_THRESHOLD = -0.85;
        ...
        public static double ATTACKS_CAST_TIMING_REDUCTION_RATE = 0.2;
        static void setATTACKS_CAST_TIMING_REDUCTION_RATE(double value) { ATTACKS_CAST_TIMING_REDUCTION_RATE = value; }

        public static int ATTACKS_DURATION_MULTIPLIER = 500;
        ...
        public static double IMPALEMENT_HEAD_ZONE_RATIO = 0.8;
        ...
        public static double ATTACK_CLASS_TIMING_ATTACK_START_VALUE = 0.0;
        static void setATTACK_CLASS_TIMING_ATTACK_START_VALUE(double value) { ATTACK_CLASS_TIMING_ATTACK_START_VALUE = value; }

        public static double ATTACK_CLASS_TIMING_ATTACK_END_VALUE = 1.0;
    ...
    public static class Display {
        ...
        public static int STATUS_DISPLAY_BLOCK_BRIGHTNESS = 15;
        static void setSTATUS_DISPLAY_BLOCK_BRIGHTNESS(int value) { STATUS_DISPLAY_BLOCK_BRIGHTNESS = value; }

        public static int STATUS_DISPLAY_SKY_BRIGHTNESS = 15;
    ...
    public static class Audio {
        ...
        public static float SOUNDS_GLOBAL_VOLUME = 1.0f;
        static void setSOUNDS_GLOBAL_VOLUME(float value) { SOUNDS_GLOBAL_VOLUME = value; }

        public static float SOUNDS_GLOBAL_PITCH = 1.0f;
        ...
        public static float THROW_VOLUME = 0.35f;
        static void setTHROW_VOLUME(float value) { THROW_VOLUME = value; }

        public static float THROW_PITCH = 0.4f;
        ...
        public static float ATTACK_VOLUME = 0.055f;
        static void setATTACK_VOLUME(float value) { ATTACK_VOLUME = value; }

        public static float ATTACK_PITCH = 1.5f;
    ...
    public static class Movement {
        ...
        public static double DASH_GRAB_DISTANCE_SQUARED = 8.5;
        ...
        public static double DASH_VELOCITY_DAMPING = 0.6;
        ...
        public static double TOSS_UPWARD_VELOCITY_Y = 0.25;
        ...
        // Grab configuration
        public static double GRAB_PULL_STRENGTH = 0.8;
